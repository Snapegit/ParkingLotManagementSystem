		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="车场编号" prop="chechangbianhao">
					<el-input v-model="ruleForm.chechangbianhao" placeholder="车场编号" clearable  :readonly="ro.chechangbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="车场编号" prop="chechangbianhao">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="预约时长" prop="yuyueshizhang">
					<el-input v-model="ruleForm.yuyueshizhang" placeholder="预约时长" clearable  :readonly="ro.yuyueshizhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="预约时长" prop="yuyueshizhang">
					<el-input v-model="ruleForm.yuyueshizhang" placeholder="预约时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="总费用" prop="zongfeiyong">
					<el-input v-model="zongfeiyong" placeholder="总费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zongfeiyong" label="总费用" prop="zongfeiyong">
					<el-input v-model="ruleForm.zongfeiyong" placeholder="总费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="账号" prop="zhanghao">
					<el-input v-model="ruleForm.zhanghao" placeholder="账号" clearable  :readonly="ro.zhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="账号" prop="zhanghao">
					<el-input v-model="ruleForm.zhanghao" placeholder="账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="昵称" prop="nicheng">
					<el-input v-model="ruleForm.nicheng" placeholder="昵称" clearable  :readonly="ro.nicheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="昵称" prop="nicheng">
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(json.nicheng!=''&&json.nicheng && this.$storage.get("role")!="管理员"){
						this.ruleForm.nicheng = json.nicheng
						this.ro.nicheng = true;
					}
					if(json.chepaihao!=''&&json.chepaihao && this.$storage.get("role")!="管理员"){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cheweiyuyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cheweiyuyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
