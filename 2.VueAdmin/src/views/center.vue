<template>
  <div>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="昵称" prop="nicheng">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="车牌号" prop="chepaihao">
